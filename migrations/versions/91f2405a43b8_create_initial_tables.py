...
Revision ID: 91f2405a43b8
Revises:
Create Date: 2025-07-14 15:04:16.737707
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("meta_data", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column(
            "chat_meta_data", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "transcription", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
